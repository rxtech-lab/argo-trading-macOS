...
./bin/generate_appcast ./ \
  ...
  --link https://github.com/rxtech-lab/argo-trading-macOS/releases \
  --download-url-prefix https://github.com/rxtech-lab/argo-trading-macOS/releases/download/${VERSION}/
